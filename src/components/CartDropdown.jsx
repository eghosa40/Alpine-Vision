...
export default function CartDropdown() {
    ...
    return (
        <div className="absolute right-0 top-16 w-80 rounded-lg bg-white p-4 shadow-lg transition-opacity duration-200 z-50">
                            ...
                            <li key={item.id} className="flex py-3">
                                ...
                                <div className="ml-3 flex flex-1 flex-col">
                                    <div className="flex justify-between text-sm font-medium text-gray-900">
                                        ...
                                        <p className="ml-1">{formatPrice(item.price * item.quantity)}</p>
                                    </div>
